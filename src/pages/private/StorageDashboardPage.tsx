...
import { FiAlertCircle, FiArrowRight, FiFolder } from "react-icons/fi";
...
export default function StorageDashboardPage() {
  ...
  const folders: S3Folder[] = (foldersData as any) || [];
...
/**
 * @deprecated Dùng useS3Folders và useS3Assets trực tiếp trong component.
 * Hàm này giữ lại tạm thời để không làm crash trang Detail.
 */
export function getStorageFolder(_folderId?: string) {
  return null;
}
