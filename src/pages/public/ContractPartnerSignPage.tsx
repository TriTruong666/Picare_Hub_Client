    ...
    >
      <header className="grid gap-8 border-b border-white/10 pb-10 md:grid-cols-[1fr_1.15fr]">
        <div>
          ...
          <p className="mt-3 text-[13px] text-white/35">
            Số: <strong className="font-semibold text-white/72">{contractNumber}</strong>
          </p>
        </div>
      ...
      <section className="pt-14 text-center">
        ...
        <p className="mt-3 text-[15px] text-white/62">
          Số <strong className="font-semibold text-white/82">{contractNumber}</strong>
        </p>
      ...
      <section>
        ...
        <ClauseList
          items={[
            ...
            <>4.3 Hạn mức công nợ: <strong className="font-semibold text-white/82">{creditLimit}</strong>.</>,
