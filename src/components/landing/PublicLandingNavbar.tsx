...
export function PublicLandingNavbar({
  ...
  return (
    <motion.header
      ...
      className={`pointer-events-none fixed inset-x-3 top-3 z-40 sm:inset-x-6 sm:top-4.5 ${className}`}
    >
      <div
      ...
      >
        ...
        <nav className="font-haffer absolute left-1/2 hidden -translate-x-1/2 items-center gap-7 text-[13px] font-normal tracking-normal lg:flex">
          ...
          <a
            ...
            className="nav-link-underline group cursor-pointer px-0.5 py-1.5 font-normal text-white/75 drop-shadow-[0_1px_4px_rgba(0,0,0,0.8)] transition-colors duration-200 hover:text-white"
          >
