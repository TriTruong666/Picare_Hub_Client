                ...
                >
                    {items.map((item, i) => (
                        <button
                            ...
                            className={`h-2 rounded-full cursor-pointer [transition:width_var(--ms-dot)_cubic-bezier(0.16,1,0.3,1),background-color_var(--ms-dot)_ease] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/80 ${i === index ? 'w-[22px] bg-white/95' : 'w-2 bg-white/35'
                                }`}
                            onClick={() => {
